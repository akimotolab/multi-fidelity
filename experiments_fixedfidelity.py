...
idx_fidelity = int(sys.argv[1])
seed = (int(sys.argv[2]) + 123) * 456
maxsec = int(sys.argv[3])
results = '../dat/ddcma_arch_mcr_fix{}_seed{}_maxsec{}.txt'.format(sys.argv[1], sys.argv[2], sys.argv[3])
np.random.seed(seed)

simulator = NGNetComplianceMinimization(idx_fidelity)
